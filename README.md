...
**That's it!** You now have access to 67 agents, 281 skills, and 101 legacy command shims.
...
| Commands | PASS: 101 commands   | PASS: 35 commands | **Claude Code leads** |
...
| **Commands** | 101                    | Shared | Instruction-based | 35 | 5 prompts |
...
| **Version** | Plugin | Plugin | Reference config | 2.1.0-koute.30 | Instruction layer |
